...
class GenerateProducerEntity implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $filetype = 'txt';
        $filename = "cust_DEV_{$datetime}_xxx.{$filetype}";
        ...
        foreach ($applicants as $applicant) {
            ...
            $race = $applicant->race;
            $status = $applicant->statuses()->first()->pivot->created_at->toDateString();
            $class = null;
