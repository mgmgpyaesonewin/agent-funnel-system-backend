...
class ExampleServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            module_path('Example', 'Config/config.php') => config_path('example.php'),
        ], 'config');
        $this->mergeConfigFrom(
            module_path('Example', 'Config/config.php'), 'example'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $sourcePath = module_path('Example', 'Resources/views');
    ...
    public function registerTranslations()
    {
        ...
        if (is_dir($langPath)) {
            ...
            $this->loadTranslationsFrom(module_path('Example', 'Resources/lang'), 'example');
        }
    }
    ...
    public function registerFactories()
    {
        if (! app()->environment('production') && $this->app->runningInConsole()) {
            app(Factory::class)->load(module_path('Example', 'Database/factories'));
        }
    }
