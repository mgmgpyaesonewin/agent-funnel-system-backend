...
<div
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      @if(isset($menuData[0]))
        @php
          if (auth()->user()->is_bdm === 1 || auth()->user()->is_ma === 1 || isset(auth()->user()->partner_id)) {
            $menuData[0]->menu = array_slice($menuData[0]->menu, 5, 10);
          }
        @endphp
              ...
              <li class="nav-item {{ (request()->is($menu->url)) ? 'active' : '' }} {{ $custom_classes }}">
                <a href="{{ $menu->url }}">
                  ...
                  @if (isset($menu->badge))
                    ...
                    <span
                      class="{{ isset($menu->badgeClass) ? $menu->badgeClass.' test' : $badgeClasses.' notTest' }} ">
											{{$menu->badge}}
										</span>
                  @endif
                </a>
