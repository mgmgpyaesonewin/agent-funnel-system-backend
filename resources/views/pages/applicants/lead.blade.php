        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <v-search-form current-status="lead" export-url="lead" :enable-export="false"
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body text-center">
                        <v-table ref="table" current-status="lead" :status="[1,7]" channel-col="false"
                            :assign-checkbox="true" age="true" gender="true" status-col="true" status-col="true" :user-assign="true"
