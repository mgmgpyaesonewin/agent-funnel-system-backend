      ...
      <div class="card-content">
        <ul class="list-group list-group-flush">
          <li class="list-group-item">
            <span class="float-right"><button class="btn btn-info">Export</button></span>
            Download Applicants Information
          </li>
          <li class="list-group-item">
            <span class="float-right"><button class="btn btn-warning">Import</button></span>
        ...
        <div class="form-group row mx-1">
          ...
          <div class="col-sm-8">
            <div class="custom-control custom-switch custom-switch-success custom-control-inline">
                <input type="checkbox" name="payment_option" class="custom-control-input" id="customSwitch1" onchange="event.preventDefault(); document.getElementById('option-form').submit();" @if($payment == '1') checked @endif>
        ...
        <div class="card-body">
          ...
          @foreach($msg_templates as $temp)
            <div class="form-group row mx-1">
              ...
              <div class="col-sm-9">
                <textarea class="form-control" id="exampleFormControlTextarea1" name="{{$temp->meta_key}}" rows="3">{{$temp->meta_value}}</textarea>
              </div>
            </div>
          @endforeach
          <hr>
