        ...
        <div class="card-content">
          <div class="card-body text-center">
            ...
            <div class="text-center">
              <h1 class="mb-2 text-white">Mingalarbar Yan,</h1>
    ...
    <div class="col-lg-3 col-md-6 col-12">
      <div class="card">
        <div class="card-header d-flex flex-column align-items-start pb-0">
          ...
          <button type="button" class="btn btn-outline-primary waves-effect waves-light" data-toggle="popover"
            data-placement="top" data-container="body" data-original-title="Popover on top"
