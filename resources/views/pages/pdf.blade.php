...
<body>
    ...
    <div>
        ...
        <p class="western" align="JUSTIFY" style="margin-top: 0.17in; margin-bottom: 0.08in; page-break-before: always">
            This Management AssociateAdvisor Financial Advisor Agreement (“Agreement”) is made on the
            {{ $applicant->signed_date ?? '' }} by and between,
        </p>
        ...
        <p class="western" align="JUSTIFY">
            <font face="Verdana, serif" style="margin-top: 0.08in; margin-bottom: 0.08in">
                <font face="Calibri, serif">and </font>
            </font>
        </p>
        <p class="western" align="JUSTIFY" style="margin-top: 0.08in; margin-bottom: 0.08in">
        ...
        <p class="western" align="JUSTIFY" style="margin-top: 0.08in; margin-bottom: 0.08in">
            <font face="Calibri, serif">
                <font face="Verdana, serif">The Parties have agreed to enter into this Agreement under following terms
                    and
                    conditions: </font>
            </font>
        </p>
            ...
            <p lang="en-US" align="JUSTIFY" style="margin-top: 0.08in; margin-bottom: 0.08in">
                <font size="2">
                    <font face="Verdana, serif"><span lang="en-GB"><span
                                style="font-style: normal">conspire</span></span>
                    </font>
